...
import net.mypieceofthe.java8.java8inaction.domain.carsandinsurances.Car;
import net.mypieceofthe.java8.java8inaction.domain.carsandinsurances.Insurance;
import net.mypieceofthe.java8.java8inaction.domain.carsandinsurances.Person;

import java.util.Optional;

import static net.mypieceofthe.java8.java8inaction.domain.carsandinsurances.PeopleFactory.*;
